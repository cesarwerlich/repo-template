...
## Using Skills As Commands

This template does not ship tool-specific slash-command files. Instead, ask your coding agent to use the relevant skill by name or by file path:

| Intent | Skill |
|---------|---------------|
| Define scope | spec-driven-development |
| Break down work | planning-and-task-breakdown |
| Build incrementally | incremental-implementation + test-driven-development |
| Fix or diagnose | debugging-and-error-recovery |
...
Spec and planning skills may create working artifacts such as `SPEC.md`, `tasks/plan.md`, or `tasks/todo.md`. Treat them as **living documents** while the work is in progress:
